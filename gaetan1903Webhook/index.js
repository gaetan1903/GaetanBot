...
'use strict';
// le token de la page
const PAGE_ACCESS_TOKEN = 'EAATxVtbbLZAYBACSaOij9iBjYCaVvkHghHKBhmZC2vnahBtaXSJDHZBHKMycZCMYzq5NEBjOKX5sXxD2E2JN2HSeuZA6FxH8AaemFyB3BMmHSDVgiJeFogJOXdasJyDm79XapC2ec8HeBmZBpNEslqaqWaDrbb3cAD8Ap9c1UzX28IuwhBXQ1U';
...
// creer un serveur d ecoute pour les envoyeés de Facebook
app.listen(process.env.PORT || 80, () => console.log('webhook est en ecoute'));

//fonction lancée en cas de requetes de type POST
app.post('/webhook', (req, res) => {  
  ...
  if (body.object === 'page') {
    ...
    // 404 erreur si c est pas pour la page 
    res.sendStatus(404);
  }
...
app.get('/webhook', (req, res) => {
  ...
  const VERIFY_TOKEN = 'gaetan@arch';
...
function handleMessage(sender_psid, received_message) {
  ...
  if (received_message.text) {    
	...
	request.post({
		...
		url: 'https://gaetanbot.herokuapp.com/',
